...
| [Анализ продаж и поиск аномалий в B2B-заказах](https://github.com/Mrgrozzz/b2b_sales_anomaly_analysis) | Выявил технический сбой в заказах, оценил его влияние на выручку и показал искажение ключевых бизнес-метрик. | **Python, pandas, matplotlib, seaborn** |
<!--
