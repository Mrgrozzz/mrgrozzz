...
| [анализ пользовательского поведения и метрик маркетплейса](https://github.com/Mrgrozzz/marketplace-analysis) | Анализ поведения пользователей маркетплейса и продуктовых метрик.
Исследовал Retention и выручку, выявил причины расхождения роста аудитории и дохода, сформировал продуктовые гипотезы и метрики для оценки улучшений. | **Python, pandas, numpy, matplotlib, seaborn, Jupyter Notebook** |
